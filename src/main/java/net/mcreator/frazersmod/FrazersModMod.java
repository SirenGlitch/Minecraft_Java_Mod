package net.mcreator.frazersmod;
...
import net.mcreator.frazersmod.init.FrazersModModTabs;
import net.mcreator.frazersmod.init.FrazersModModSounds;
import net.mcreator.frazersmod.init.FrazersModModPaintings;
...
@Mod("frazers_mod")
public class FrazersModMod {
	public static final Logger LOGGER = LogManager.getLogger(FrazersModMod.class);
	public static final String MODID = "frazers_mod";

	public FrazersModMod(IEventBus modEventBus) {
		// Start of user code block mod constructor
		// End of user code block mod constructor
		NeoForge.EVENT_BUS.register(this);
		modEventBus.addListener(this::registerNetworking);
		FrazersModModSounds.REGISTRY.register(modEventBus);
		FrazersModModBlocks.REGISTRY.register(modEventBus);

		FrazersModModItems.register(modEventBus);

		FrazersModModTabs.REGISTRY.register(modEventBus);

		FrazersModModPaintings.REGISTRY.register(modEventBus);
